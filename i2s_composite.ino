...
void i2s_composite_write_line(unsigned short *line) {
  ...
  size_t bytes_to_write = buffer_length * sizeof(unsigned short); // I2S_BITS_PER_SAMPLE_16BIT
  size_t cursor = 0; // bytes
...
void i2s_composite_init(int buf_len) {
...
struct i2s_composite_namespace i2s_composite = {
  .init = i2s_composite_init,
  .write_line = i2s_composite_write_line
};
